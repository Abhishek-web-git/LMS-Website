    ...
    <div className='flex min-h-screen bg-gray-100'>
      ...
      <div className='flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-3'>
        ...
        <div className='flex items-center justify-center gap-3'>
          ...
          <button className='bg-[black] text-white px-4 py-2 rounded hover:bg-gray-500 cursor-pointer' onClick={()=>navigate("/createcourse")}>Create Courses</button>
        </div>
      ...
      <div className='hidden md:block bg-white rounded-xl shadow p-4 overflow-x-auto'>
        ...
        <table className='min-w-full text-sm'>
          ...
          <tbody>
            ...
            <tr key={index} className='border-b hover:bg-gray-50 transition duration-200'>
              ...
              <td className='px-4 py-3'><span className={`px-3 py-1 rounded-full text-xs ${course?.isPublished ? "bg-green-600": "bg-red-100 text-red-600"} `}>{course?.isPublished ? "Published": "Draft"}</span></td>
        ...
        <p className='text-center text-sm text-gray-400 mt-6'>A list of your recent courese.</p>
      ...
      <div className='md:hidden space-y-4'>
        ...
        <div key={index} className='bg-white rounded-lg shadow p-4 flex flex-col gap-3'>
          <div className='flex gap-4 items-center'>
            ...
            {course?.thumbnail?<img src={course?.thumbnail} alt='' className='w-16 h-16 rounded-md object-cover'/>: <img src={img} alt="" className='w-16 h-16 roounded-md object-cover'/>}
        ...
        <p className='text-center text-sm text-gray-400 mt-4'>A list of your recent courese.</p>
