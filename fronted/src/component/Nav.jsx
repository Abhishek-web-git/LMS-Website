      ...
      <div>
        <div className='w-[100%] h-[70px] fixed top-0 px-[20px] py-[10px] flex items-center justify-between bg-[#00000047] z-10'>
          ...
          <div className='w-[30%] lg:flex items-center justify-center gap-4 hidden'>
            ...
            {/*userdata hamare pass nahi to tab hame login dikhana h warna logout dikhana h */}
            ...
            {!userData && <IoPersonCircle className='w-[50px] -[50px] h-[50px] fill-black cursor-pointer'  />}
            ...
            {!userData ? <span className='w-[200px] h-[65px] border-2 border-white text-white flex items-center justify-center rounded-[10px] text-[18px] font-light cursor-pointer bg-[#000000d5]' onClick={()=>navigate("/login")}>Login</span> :
            <span className='w-[200px] h-[65px] flex items-center justify-center bg-white text-black rounded-[10px] shadow-sm shadow-black text-[18px] cursor-pointer' onClick={handleLogOut}>LogOut</span> }  
